        ...
        <div className="mt-14 divide-y divide-border border-y border-border">
          {whyUs.map((item, i) => (
            <Reveal key={item.name} delay={i * 0.03}>
              <div className="grid gap-2 py-5 sm:grid-cols-[16rem_1fr] sm:items-baseline sm:gap-8">
                <h3 className="font-display text-lg text-foreground sm:text-xl">{item.name}</h3>
