...
<form method="post" action="?action=details" role="form" class="bg-seccolorstyle bg-white noshadow mt-50 p-50 br-12">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="inputPaymentMethod" class="control-label c-black mergecolor">{$LANG.paymentmethod}</label>
            ...
            <div class="form-group">
                <label for="inputBillingContact" class="control-label c-black mergecolor">{$LANG.defaultbillingcontact}</label>
            ...
            <div class="form-group">
                <label for="inputLanguage" class="col-form-label c-black mergecolor">{$LANG.clientarealanguage}</label>
            ...
            {if $customfields}
                {foreach from=$customfields key=num item=customfield}
                    <div class="form-group">
                        <label class="control-label c-black mergecolor" for="customfield{$customfield.id}">{$customfield.name}</label>
                        <div class="control">
    ...
    {if $showMarketingEmailOptIn}
        <div class="marketing-email-optin bg-colorstyle bg-pratalight noshadow mt-50 mb-5">
            <h2 class="mergecolor c-black">{lang key='emailMarketing.joinOurMailingList'}</h2>
            <p class="mergecolor c-black f-14 mb-5">{$marketingEmailOptInMessage}</p>
