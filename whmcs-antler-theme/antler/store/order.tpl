    ...
    <form method="post" action="{routePath('cart-order-addtocart')}" id="frmAddToCart">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-md-12 text-center">
                    <h2 class="section-heading c-black mergecolor">{$product->name}</h2>
                    <p class="section-subheading whitecolor mergecolor mt-0">{$product->description}</p>
                </div>
            </div>
        </div>

        <div class="bg-seccolorstyle bg-pratalight mt-50 mb-5 p-80 br-12 p-relative mergecolor">

            <div class="payment-term">
                <p class="text-muted mergecolor">{lang key='store.choosePaymentTerm'}</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-7 text-right">
                ...
                <button type="submit" name="checkout" value="1" class="btn btn-primary ml-5">
